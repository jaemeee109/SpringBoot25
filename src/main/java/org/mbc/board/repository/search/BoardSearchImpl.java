...
public class BoardSearchImpl extends QuerydslRepositorySupport implements BoardSearch {
    ...
    public Page<Board> search1(Pageable pageable) {
        ...
        // 다중 조건일때 연산자 공식에 의해서 특수 기호가 먼저 계산 될 때가 있다
        ...
        query.where(board.bno.gt(0L)); // pk를 이용해서 빠른 검색
    ...
    public Page<Board> searchAll(String[] types, String keyword, Pageable pageable) {
        ...
        // 프론트에서 검색 폼에 keyword가 비었을 경우도 있고, 있을 경우도 있다
            ...
            for (String type : types){ // 파라미터로 넘어온 값을 String[] types
                switch (type){
                    ...
                    case "w" : // 작성자면
                        ...
                        break;
                }//switch 종료 , 프론트에서 넘어오는 String[]값을 파악하고 적용
        ...
        this.getQuerydsl().applyPagination(pageable, query); // 페이징 처리 코드 + 쿼리
